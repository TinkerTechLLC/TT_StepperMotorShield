...
<library name="Custom">
<packages>
<package name="A9488_STEP_STICK">
<pad name="EN" x="-6.35" y="8.89" drill="0.8" shape="square"/>
<pad name="MS1" x="-6.35" y="6.35" drill="0.8"/>
<pad name="MS2" x="-6.35" y="3.81" drill="0.8"/>
<pad name="MS3" x="-6.35" y="1.27" drill="0.8"/>
<pad name="RES" x="-6.35" y="-1.27" drill="0.8"/>
<pad name="SLP" x="-6.35" y="-3.81" drill="0.8"/>
<pad name="STP" x="-6.35" y="-6.35" drill="0.8"/>
<pad name="DIR" x="-6.35" y="-8.89" drill="0.8"/>
<pad name="GND1" x="6.35" y="-8.89" drill="0.8"/>
<pad name="+5V" x="6.35" y="-6.35" drill="0.8"/>
<pad name="A2" x="6.35" y="-3.81" drill="0.8"/>
<pad name="A1" x="6.35" y="-1.27" drill="0.8"/>
<pad name="B1" x="6.35" y="1.27" drill="0.8"/>
<pad name="B2" x="6.35" y="3.81" drill="0.8"/>
<pad name="GND2" x="6.35" y="6.35" drill="0.8"/>
<pad name="V+" x="6.35" y="8.89" drill="0.8"/>
<wire x1="-7.62" y1="10.16" x2="7.62" y2="10.16" width="0.127" layer="21"/>
<wire x1="7.62" y1="10.16" x2="7.62" y2="-10.16" width="0.127" layer="21"/>
<wire x1="7.62" y1="-10.16" x2="-7.62" y2="-10.16" width="0.127" layer="21"/>
<wire x1="-7.62" y1="-10.16" x2="-7.62" y2="10.16" width="0.127" layer="21"/>
<text x="-5.08" y="8.255" size="1.27" layer="21">EN</text>
<text x="-5.08" y="5.715" size="1.27" layer="21">MS1</text>
<text x="-5.08" y="3.175" size="1.27" layer="21">MS2</text>
<text x="-5.08" y="0.635" size="1.27" layer="21">MS3</text>
<text x="-5.08" y="-1.905" size="1.27" layer="21">RES</text>
...
<text x="3.175" y="8.255" size="1.27" layer="21">V+</text>
<text x="1.27" y="5.715" size="1.27" layer="21">GND</text>
<text x="3.175" y="3.175" size="1.27" layer="21">B2</text>
<text x="3.175" y="0.635" size="1.27" layer="21">B1</text>
<text x="3.175" y="-1.905" size="1.27" layer="21">A1</text>
<text x="3.175" y="-4.445" size="1.27" layer="21">A2</text>
<text x="1.905" y="-6.985" size="1.27" layer="21">+5V</text>
<text x="1.27" y="-9.525" size="1.27" layer="21">GND</text>
<text x="-2.54" y="10.16" size="1.27" layer="25">&gt;NAME</text>
<text x="-2.54" y="-11.43" size="1.27" layer="27">&gt;VALUE</text>
</package>
</packages>
<symbols>
<symbol name="A4988_STEP_STICK">
<pin name="EN" x="-15.24" y="17.78" length="middle" direction="in"/>
<pin name="MS1" x="-15.24" y="12.7" length="middle" direction="in"/>
<pin name="MS2" x="-15.24" y="7.62" length="middle" direction="in"/>
<pin name="MS3" x="-15.24" y="2.54" length="middle" direction="in"/>
<pin name="RES" x="-15.24" y="-2.54" length="middle" direction="in"/>
<pin name="SLP" x="-15.24" y="-7.62" length="middle" direction="in"/>
<pin name="STP" x="-15.24" y="-12.7" length="middle" direction="in"/>
<pin name="DIR" x="-15.24" y="-17.78" length="middle" direction="in"/>
<pin name="V+" x="15.24" y="17.78" length="middle" direction="pwr" rot="R180"/>
<pin name="GND2" x="15.24" y="12.7" length="middle" direction="pwr" rot="R180"/>
...
<pin name="A2" x="15.24" y="-7.62" length="middle" direction="out" rot="R180"/>
<pin name="+5V" x="15.24" y="-12.7" length="middle" direction="pwr" rot="R180"/>
<pin name="GND1" x="15.24" y="-17.78" length="middle" direction="pwr" rot="R180"/>
...
<devicesets>
<deviceset name="A4988_STEP_STICK">
<gates>
<gate name="G$1" symbol="A4988_STEP_STICK" x="0" y="0"/>
</gates>
<devices>
<device name="" package="A9488_STEP_STICK">
<connects>
<connect gate="G$1" pin="+5V" pad="+5V"/>
<connect gate="G$1" pin="A1" pad="A1"/>
<connect gate="G$1" pin="A2" pad="A2"/>
...
<connect gate="G$1" pin="STP" pad="STP"/>
...
<net name="2-STP" class="0">
<segment>
<pinref part="U2" gate="G$1" pin="STP"/>
...
<errors>
<approved hash="204,1,27.94,66.04,U$1,VIN,,,,"/>
<approved hash="104,1,27.94,68.58,U$1,GND1,GND,,,"/>
<approved hash="104,1,27.94,71.12,U$1,GND2,GND,,,"/>
<approved hash="104,1,182.88,91.44,U1,VDD,3V,,,"/>
<approved hash="202,1,182.88,78.74,U1,4A,,,,"/>
<approved hash="104,1,114.3,134.62,U2,VS-,GND,,,"/>
<approved hash="104,1,114.3,137.16,U2,VS+,N$4,,,"/>
</errors>
</schematic>
</drawing>
</eagle>
